...
from dataset import MiniImageNetMetaLearning, OmniglotMetaLearning, get_train_test_classes, train_folders_miniimagenet, val_folders_miniimagenet, test_folders_miniimagenet
from _train import train
def main(dataset, n, n_s, n_q, epochs=1000):
