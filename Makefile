...
train-paper-miniimagenet:
	python train.py --dataset=miniimagenet --classes=30 -s=1 -q=15 --lr=1e-3 --lr-decay=True --lr-decay-gamma=0.5 --lr-decay-steps=3000 --device=cuda:1 --batch-size=4
	python train.py --dataset=miniimagenet --classes=20 -s=5 -q=15 --lr=1e-3 --lr-decay=True --lr-decay-gamma=0.5 --lr-decay-steps=3000 --device=cuda:1 --batch-size=4
